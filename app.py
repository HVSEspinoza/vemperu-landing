...
# CATÁLOGO COMPLETO CON PRECIOS PSICOLÓGICOS (terminan en 9 o 99)
PRODUCTS = [
    {
        "id": "office2021",
        "name": "Microsoft Office Professional Plus 2021",
        "price": 79,        # era 80 → ahora 79
        "old_price": 599,
        "highlight": False,
    ...
    },
    {
        "id": "windows11",
        "name": "Windows 11 Pro",
        "price": 79,        # se mantiene (ya era atractivo)
        "old_price": 499,
        "highlight": True,  # Más vendido
